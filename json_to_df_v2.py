...
print(df_easy[df_easy["developers"] == "Unknown"])
...
df_games_genre.to_csv("data_files/gamesid_genreid.csv")
df_genre.to_csv("data_files/different_genres.csv")
df_easy.to_csv("data_files/steam_games_v2.csv")
